...
USpringArmComponent* UMyWarriorHeroGameplayAbility::GetHeroSpringArmComponentFromActorInfo()
{
	return GetMyWarriorHeroCharacterFromActorInfo()->ReturnMySpringArmComponent();
}
