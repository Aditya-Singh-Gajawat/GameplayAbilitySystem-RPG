...
AMyWarriorHeroCharacter::AMyWarriorHeroCharacter()
{
	...
	CameraBoom->TargetArmLength = 400.f;  // Set how far behind the camera should be from the character
...
UPawnCombatComponent* AMyWarriorHeroCharacter::Interface_ReturnPawnCombatComponent()
{
...
void AMyWarriorHeroCharacter::GetLightComboCounterValueForActor(int InComboCounter)
{
	OutLightComboCounter = InComboCounter;
}

void AMyWarriorHeroCharacter::GetHeavyComboCounterValueForActor(int InComboCounter)
{
	OutHeavyComboCounter = InComboCounter;
}
