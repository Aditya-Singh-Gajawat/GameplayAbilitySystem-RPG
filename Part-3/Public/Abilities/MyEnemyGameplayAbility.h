...
protected:
	...
	UFUNCTION(BlueprintPure, Category = "Warrior|Ability")
	FGameplayEffectSpecHandle InitializeEnemyDamageEffectSpecHandle(TSubclassOf<UGameplayEffect> GameplayEffectClass, const FScalableFloat InScalableFloatDamage);
private:
